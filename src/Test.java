...
public class Test {
    ...
    public static void main(String[] args) throws IllegalStateException,
            HPoolExhaustedException, Exception {

        


        /*CassandraClientPool clientPool = CassandraClientPoolFactory
        .getInstance().createNew(new String[] { "139.91.96.87:9160" });
         *
        FSCliMain cli = new FSCliMain();
        cli.connect();
        cli.processCommand("rm /usr/nick/bigFile.zip");//("copyFromLocal C:\\tmp\\bigFile.zip /usr/ftylitak/bigFile.zip");
         * */
        // test();
